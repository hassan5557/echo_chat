...
const UserSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'contactCreatedAt': PropertySchema(
      id: 1,
      name: r'contactCreatedAt',
...
void _userSerialize(
  ...
  writer.writeDateTime(offsets[1], object.contactCreatedAt);
...
User _userDeserialize(
  ...
  final object = User(
    ...
    contactCreatedAt: reader.readDateTimeOrNull(offsets[1]),
...
extension UserQueryFilter on QueryBuilder<User, User, QFilterCondition> {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> contactCreatedAtIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'contactCreatedAt',
      ));
    });
  }

  QueryBuilder<User, User, QAfterFilterCondition> contactCreatedAtIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'contactCreatedAt',
      ));
  ...
  QueryBuilder<User, User, QAfterFilterCondition> contactCreatedAtEqualTo(
      DateTime? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'contactCreatedAt',
  ...
  QueryBuilder<User, User, QAfterFilterCondition> contactCreatedAtGreaterThan(
    DateTime? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> contactCreatedAtLessThan(
    DateTime? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> contactCreatedAtBetween(
    DateTime? lower,
    DateTime? upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension UserQuerySortBy on QueryBuilder<User, User, QSortBy> {
  ...
  QueryBuilder<User, User, QAfterSortBy> sortByContactCreatedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'contactCreatedAt', Sort.asc);
    });
  }

  QueryBuilder<User, User, QAfterSortBy> sortByContactCreatedAtDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'contactCreatedAt', Sort.desc);
    });
  }
...
extension UserQuerySortThenBy on QueryBuilder<User, User, QSortThenBy> {
  ...
  QueryBuilder<User, User, QAfterSortBy> thenByContactCreatedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'contactCreatedAt', Sort.asc);
    });
  }

  QueryBuilder<User, User, QAfterSortBy> thenByContactCreatedAtDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'contactCreatedAt', Sort.desc);
    });
  }
...
extension UserQueryWhereDistinct on QueryBuilder<User, User, QDistinct> {
  ...
  QueryBuilder<User, User, QDistinct> distinctByContactCreatedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'contactCreatedAt');
    });
  }
...
extension UserQueryProperty on QueryBuilder<User, User, QQueryProperty> {
  ...
  QueryBuilder<User, DateTime?, QQueryOperations> contactCreatedAtProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'contactCreatedAt');
    });
  }
